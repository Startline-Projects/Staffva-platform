...
export default function ForCandidatesSection({
  ...
  const stats = [
    {
      value: totalApproved > 0 ? totalApproved.toString() : "50+",
    ...
    {
      value: uniqueCountries > 0 ? uniqueCountries.toString() : "10+",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="mt-10">
              <Link
                href="/apply"
                className="inline-flex items-center gap-2 rounded-lg bg-primary px-8 py-3.5 text-sm font-semibold text-white hover:bg-primary-dark transition-colors"
              >
                Apply Now
                <svg
                  className="w-4 h-4"
