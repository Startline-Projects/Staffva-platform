...
<p>Either party may pause this engagement through the StaffVA platform. While paused, no new payment periods accrue; funds already held in escrow continue to follow the Platform's escrow release policies. The pausing party may resume the engagement at any time. If the engagement remains paused for thirty (30) consecutive days, this Agreement terminates as though notice had been given and the notice period completed.</p>
