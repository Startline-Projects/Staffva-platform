...
// route cannot drift; the DB keeps frozen copies in migration `client_signup_capture`'s CHECK
...
export async function POST(request: Request) {
  ...
  // 'client') inside auth.signUp itself, and since `client_signup_capture` it persists the
