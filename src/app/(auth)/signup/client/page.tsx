...
export default function ClientSignupPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // Send verification email. If this fails the account is unusable — login
    // signs the user back out until the link in that email is clicked — so
    // surface it rather than showing "check your email".
