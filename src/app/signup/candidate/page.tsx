...
export default function CandidateSignupPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // unless the Cloudflare script itself failed to load, in which case the
    // call proceeds tokenless and the server decides.
    ...
    // the capture atomically (`client_signup_capture`). ensure-profile is the belt.
    ...
    if (signUpData?.user) {
      ...
      // do not show success over a 500. (The token was consumed by the
      // signUp above; reset so a retry gets a fresh challenge.)
      if (!profileRes.ok) {
        if (captcha.configured) captcha.reset();
        setAlert({
            ...
            <section className="form-col" aria-labelledby="form-title">
              ...
              <div className="form-card">
                ...
                <form ref={formRef} onSubmit={handleSubmit} noValidate autoComplete="on">
                  ...
                  {captcha.configured && <div ref={captcha.containerRef} style={{ marginTop: "16px" }} />}
