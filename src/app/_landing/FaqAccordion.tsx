...
const FAQ_ITEMS = [
  ...
  {
    q: 'How do I pay — what currencies and cards are accepted?',
    a: `<p>All payments run through <strong>Stripe</strong>. We accept all major credit and debit cards — Visa, Mastercard, American Express, Discover. All transactions are in <strong>USD</strong>, and funds are held in escrow until you release them.</p>`,
  },
  {
    q: 'What if I need to pause or end the engagement?',
    a: `<p>End it whenever. <strong>No notice period, no early-termination fees, no questions asked.</strong> Any funds already captured for an upcoming cycle that hasn't started yet are refunded. If you need to pause and come back, message the professional directly — most are happy to hold the role open if they know your timeline.</p>`,
  },
];
