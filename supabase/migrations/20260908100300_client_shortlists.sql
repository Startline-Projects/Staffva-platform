-- 20260908100300_client_shortlists — named shortlists and saved searches (client vertical step 8).
--
...
-- service-role route that checks ownership, which is the shape `client_notifications` settled
